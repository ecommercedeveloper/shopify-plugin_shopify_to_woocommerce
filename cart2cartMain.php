 ...
 */
/*
Plugin Name: Cart2Cart: Shopify to WooCommerce Migration Module
  ...
  switch ($action){
    ...
    case 'checkApi':
      $opt = array(
        ...
        'blocking'    => true,
        'headers'     => array(
          'X-Shopify-Access-Token' => $_REQUEST['apipass'],
      ...
      $res = wp_remote_get(trim((string)urldecode($_REQUEST['url']), '/').'/admin/shop.json', $opt);
...
function cart2cart_config(){
  ...
  $sourceCartName = 'Shopify';
  $sourceCartId   = 'Shopify';
